...
public class Scalper {
    public static void main(String[] args) throws InterruptedException {
        ...
        //stop program for 1 second
        Thread.sleep(1000);
        // while loop will keep going until it reaches the if statement
        boolean y = true;
        while (y) {
            ...
            //driver will refresh until there is an add to cart button present, or the user manually switches the driver off.
            else
            {
                Thread.sleep(500);
